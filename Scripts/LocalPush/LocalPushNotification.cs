...
public static class LocalPushNotification
{
    ...
    public static void AddScheduleRepeat(string title, string message, int badgeCount, int elapsedTime, string cannelId,TimeSpan timeSpan) 
    {
#if UNITY_ANDROID
        SetAndroidNotificationRepeat(title, message, badgeCount, elapsedTime, cannelId,timeSpan);
#endif
#if UNITY_IOS
        SetIOSNotificationRepeat(title, message, badgeCount, elapsedTime,timeSpan);
#endif
    }
    ...
    /// <param name="badgeCount"></param>
    /// <param name="elapsedTime"></param>
    static private void SetIOSNotificationRepeat(string title, string message, int badgeCount, int elapsedTime,TimeSpan timeSpan)
    {
        // 通知を作成します。
        iOSNotificationCenter.ScheduleNotification(new iOSNotification()
        {
    ...
    /// <param name="elapsedTime"></param>
    /// <param name="cannelId"></param>
    static private void SetAndroidNotificationRepeat(string title, string message, int badgeCount, int elapsedTime, string cannelId ,TimeSpan timeSpan)
    {
        // 通知を作成します。
        var notification = new AndroidNotification
        {
